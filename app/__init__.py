...
from .api.shoppingCartItem_routes import cartItem_routes
...
app.register_blueprint(items_routes, url_prefix='/api')
app.register_blueprint(shoppingCart_routes, url_prefix='/api')
